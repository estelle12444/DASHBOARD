                ...
                <div class="navbar-header"  >
                    <ul class="nav navbar-nav flex-row" >
                        <li class="nav-item mobile-menu d-lg-none mr-auto">
                            <Link class="nav-link nav-menu-main menu-toggle hidden-xs" to="#"><i class="ft-menu font-large-1"></i></Link></li>
                        <li class="nav-item mr-auto">
                            <Link class="navbar-brand" to="/tracetube">
                                {/*<img class="brand-logo" alt="modern admin logo" src={logo} />*/}
                                <h3 class="brand-text"> {props.name}</h3>
                            </Link>
                        </li>
                ...
                <div class="navbar-container content">
                    <div class="collapse navbar-collapse" id="navbar-mobile">
                        ...
                        <ul class="nav navbar-nav mr-auto float-center">
                            <li class="nav-item d-none d-lg-block"></li>
                            <img className="brand-logo" alt="modern admin logo" src={logo} />
                        ...
                        <ul class="nav navbar-nav float-right">
                            ...
                            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"><span class="mr-1 user-name text-bold-700">Pascale</span><span class="avatar avatar-online"><img src="../../../app-assets/images/portrait/small/avatar-s-18.png" alt="avatar" /><i></i></span></a>
