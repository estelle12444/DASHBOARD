...
$(document).ready((function(){var e={chart:{height:550,type:"radialBar"},
responsive:[{breakpoint:530,options:{chart:{height:350}}}],
plotOptions:{radialBar:{dataLabels:{name:{fontSize:"22px"},
value:{fontSize:"16px"},total:{show:!0,label:"Total",formatter:function(e){return 249}}}}},
fill:{colors:$themeColor},series:[44,55,67,83],labels:["Apples","Oranges","Bananas","Berries"]};new ApexCharts(document.querySelector("#invoice-total-recievables"),e).render();var t={chart:{height:350,type:"bar"},plotOptions:{bar:{horizontal:!1,columnWidth:"55%",endingShape:"rounded"}},dataLabels:{enabled:!1},stroke:{show:!0,width:2,colors:["transparent"]},
...
new ApexCharts(document.querySelector("#your-top-expenses"),o).render()}));